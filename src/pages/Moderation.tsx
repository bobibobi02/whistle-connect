      ...
      <main className="container max-w-6xl mx-auto px-4 py-6">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-muted-foreground">AI-powered content moderation overview</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          ...
          <Card>
            <CardHeader className="pb-2">
              ...
              <CardTitle className="text-3xl">{stats?.last24h || 0}</CardTitle>
            </CardHeader>
          </Card>
          <Card>
            <CardHeader className="pb-2">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Recent content moderation activity</CardDescription>
          </CardHeader>
          <CardContent>
            <Tabs defaultValue="all">
              <TabsList className="mb-4">
                ...
                <TabsTrigger value="allowed">Allowed ({allowedLogs.length})</TabsTrigger>
              </TabsList>
              ...
              <TabsContent value="allowed">
                <ModerationLogsList logs={allowedLogs} loading={logsLoading} />
              </TabsContent>
            </Tabs>
          </CardContent>
        </Card>
